(function(){
  ...
  function renderDetail(){
    ...
    screen?.classList.toggle('asset53-stock-detail-screen',section==='stock'&&detailState.tab==='overview'&&!!detailState.stockDetail);
    body.classList.toggle('asset53-wide-asset-mode',['cash','gold','insurance','realestate','saving'].includes(section));
    body.classList.toggle('asset53-insurance-contract-detail',section==='insurance'&&detailState.tab==='overview'&&!!detailState.insuranceContractDetail);
    body.classList.toggle('asset53-stock-detail',section==='stock'&&detailState.tab==='overview'&&!!detailState.stockDetail);
    body.classList.toggle('asset53-stock-movement-mode',section==='stock'&&detailState.tab==='movement');
    body.classList.toggle('asset53-stock-trade-mode',section==='stock'&&detailState.tab==='movement'&&detailState.stockMovementView==='detail');
    body.classList.toggle('asset53-stock-overview-mode',section==='stock'&&detailState.tab==='overview'&&!detailState.stockDetail);
    body.classList.toggle('asset53-compact-ledger',['insurance','realestate','stock','saving'].includes(section));
    body.classList.toggle('asset53-fixed-detail',cash||detailState.tab==='movement'||(section==='stock'&&detailState.tab==='overview'&&!detailState.stockDetail));
    if(cash){
